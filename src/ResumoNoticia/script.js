    ...
    const noticias = [
        {
           ...
           "SubNoticia1": [
            ...
            "TopNoticia1": [
                {
                    id: "TP1",
                    Imagem: "../imgNoticia/EnergiaNor.jpg",
            ...
            "TopNoticia2": [
                {
                    id: "TP2",
                    Imagem: "../imgNoticia/Restaura.jpg",
            ...
            "TopNoticia3": [
                {
                    ...
                    "Noticia": "O programa oferece atendimento psicológico gratuito, com o objetivo de ajudar esses jovens a lidar com traumas, ansiedade, depressão e outros desafios emocionais. Além das sessões de terapia, o projeto inclui workshops sobre saúde mental, grupos de apoio e atividades recreativas que promovem o bem-estar e a autoestima. Os profissionais envolvidos no projeto são psicólogos e terapeutas experientes, que trabalham de forma voluntária para proporcionar um ambiente seguro e acolhedor para os jovens. A ONG também está estabelecendo parcerias com escolas e outras instituições comunitárias para identificar e encaminhar jovens que possam se beneficiar do programa. A iniciativa visa não apenas tratar problemas de saúde mental, mas também prevenir o agravamento de condições emocionais através de intervenções precoces. Ao oferecer suporte contínuo e personalizado, a ONG Caminhos para o Futuro espera capacitar esses jovens a superar suas dificuldades e construir um futuro mais promissor. Para mais informações sobre o programa e como participar, visite o site oficial da ONG Caminhos para o Futuro. Juntos, podemos fazer a diferença na vida desses jovens e promover uma sociedade mais saudável e solidária."
                }
            ],
            "Noticia1": [
                {
                    id: "T1",
                    Imagem: "../imgNoticia/Mulher.jpg",
...
function carregarConteudo() {
    ...
    noticias.forEach((categoria) => {
        // Iterar pelas chaves das categorias
        for (let chave in categoria) {
            // Iterar pelas notícias dentro de cada chave
            categoria[chave].forEach((noticia) => {
                // Verifica se o ID da notícia corresponde ao parâmetro da URL
                if (noticia.id === noticiaId) {
                    // Preenche o título
                    const titulo = document.getElementById('tituloResumo');
                    if (titulo) {
                    ...
                    if (materia) {
                        materia.textContent = noticia.Noticia;
                    }
